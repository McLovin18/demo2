...
const socialLinks = [
  { href: "https://www.instagram.com/moonchild_ec/", label: "Instagram", Icon: IconInstagram },
];

// 👉 Información del negocio
const WHATSAPP_NUMBER = "593983262517"; // solo números, con código de país, sin '+' ni espacios
const WHATSAPP_DISPLAY = "+593 98 326 2517"; // como se muestra al usuario
      ...
      <footer className=" border-t border-white/10 text-white">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
              ...
              <div className="text-xs text-white/60 mt-1 max-w-[220px]">
                <p>You Shine · Ropa y accesorios personalizados</p>
                <p className="flex items-center gap-1 justify-center md:justify-start mt-0.5">
                  <IconLocation />
                  Portoviejo, Manabí · Envíos a todo el Ecuador 🇪🇨
                </p>
              </div>
            </div>
        ...
        <div className={styles.ftCopyRow}>
          <p className="text-xs text-white/50">
            © {new Date().getFullYear()} Moonchild. Todos los derechos reservados.
          </p>
          <div className={styles.ftCopyRight}>
            <div className="flex items-center gap-1.5 text-xs text-white/60">
              <div className="w-1.5 h-1.5 rounded-full bg-[#8B7CD8]" />
              Hecho en Ecuador
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs text-white/50 hover:text-[#8B7CD8] transition-colors"
              onClick={() => trackLinkClick().catch(console.error)}
            >
